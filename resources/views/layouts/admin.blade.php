...
<head>
  ...
  <!-- inject:css -->
  {!! Html::style("stylesheet" href="css/style.css") !!}
  @yield('styles')
...
<body>
  ...
  <!-- plugins:js -->
  {!! Html::styles("melody/vendors/js/vendor.bundle.base.js") !!}
  {!! Html::styles("melody/vendors/js/vendor.bundle.addons.js") !!}
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  {!! Html::styles("melody/js/off-canvas.js") !!}
  {!! Html::styles("melody/js/hoverable-collapse.js") !!}
  {!! Html::styles("melody/js/misc.js") !!}
  {!! Html::styles("melody/js/settings.js") !!}
  {!! Html::styles("melody/js/todolist.js") !!}
  <!-- endinject -->
  <!-- Custom js for this page-->
  {!! Html::styles("js/dashboard.js") !!}
